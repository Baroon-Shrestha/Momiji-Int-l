      ...
      <div className="container mx-auto px-4 maxl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl max-w-4xl font-extralight mx-auto">
            Our biggest strength lies in offering accurate, up-to-date
            information about Japanese institutions, entry requirements, and
            cultural adaptation. With an experienced and passionate team, we
            ensure a seamless experience that saves you time and gives you
            confidence.
          </p>
        </div>
        ...
        <div className="text-center mt-12 bg-white rounded-4xl">
          <div className="text-slate-600 rounded-2xl p-8 shdow-lg">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 font-extralight">
              Join thousands of successful students who chose us for their
